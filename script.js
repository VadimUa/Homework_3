...
let revievsSort = data.sort(function(a, b) { return parseInt(b.ratingRevievs) - parseInt(a.ratingRevievs); });

console.log(revievsSort);


let priceSort = data.sort(function(a, b) { 
  if(typeof a.price == "object" ) {
    a.price = a.price.newUan.replace(/\s/,"");
    return parseInt(b.price) - parseInt(a.price);
  }
    a.price = a.price.replace(/\s/,"");
    b.price =b.price.replace(/\s/,"");
    return  parseInt(b.price) - parseInt(a.price);
});
